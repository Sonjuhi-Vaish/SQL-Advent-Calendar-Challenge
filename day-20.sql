...
SELECT b.break_id, c.cocoa_id,c.cocoa_name, l.location_id, l.location_name
FROM break_schedule AS b 
LEFT JOIN cocoa_logs AS cl
ON b.break_id=cl.break_id
JOIN cocoa_types AS c 
